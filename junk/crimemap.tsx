//React Imports
import { Platform, Image, StyleSheet, Pressable, View, Text, ImageSourcePropType, Modal } from "react-native";
import MapView from "react-native-maps";
import {Map, APIProvider, useMapsLibrary, useMap} from "@vis.gl/react-google-maps";
import { GestureHandlerRootView } from "react-native-gesture-handler";
import { useMemo, useCallback, useRef, useState, useEffect } from "react";
import { collection, GeoPoint, getDocs } from "@react-native-firebase/firestore";
...
import { CrimeType, MarkerType, crimeImages } from "../../constants/data/marker";
import { loadMarkersFromFirestore, MarkersCollection } from "@/constants/markers";
...
export default function CrimeMap({ navigation }: { navigation: any }) {
  ...
  if (Platform.OS === "android") {
    ...
    const [markersCollection, setMarkersCollection] = useState<MarkersCollection>([]);
